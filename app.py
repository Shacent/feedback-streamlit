...
if page == "Pendahuluan":
    ...
    - 💬 **Feedback Terfokus**: Lihat komentar dari praktikan terkait aspek tertentu.
    - ⚙️ **Kemudahan Penggunaan**: Cukup unggah file CSV dan dapatkan hasilnya!

    ## Apa yang Bisa Anda Lakukan?
    - ✅ Unggah file feedback praktikan.
    - ✅ Pilih aspek seperti Pengajar, Asisten, Materi, atau Fasilitas.
    - ✅ Lihat hasil analisis skor dan komentar untuk meningkatkan kualitas praktikum.
